...
- [ ] Create mock agentic tools , such as a simulated Python function like initiate_wire_transfer(). Mock Agent should be able to read invoices, initiate wire transfer, or request wire transfers.
...
- [ ] Enforce a strict predefined JSON schema to filter out malicious code or weird conversational outputs.
